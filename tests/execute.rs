...
use evmodin::{host::DummyHost, opcode::*, tracing::NoopTracer, util::*, *};
use hex_literal::hex;
use std::cmp::max;

#[test]
fn simple_bench() {
    let code = hex!("");
    let message = Message {
        kind: CallKind::Call,
        is_static: true,
        depth: 0,
        ...
        sender: Address::zero(),
        input_data: hex!(
            "558badd700000000000000000000000000000000000000000000000000000000000186a0"
        )
        .to_vec()
        .into(),
        value: U256::zero(),
    ...
    let a = AnalyzedCode::analyze(code);
